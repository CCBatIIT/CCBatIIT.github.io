---
title: "CCB Lab - Resources"
layout: textlay
excerpt: "CCB Lab -- Resources."
sitemap: false
permalink: /resources
---
...
* [Occupancy Fingerprinter](https://github.com/jimtufts/occupancy_fingerprinter) is our fast code to compute occupany fingerprints, a grid of points that are one when the space near them contains and atom and zero otherwise. It is described in [Journal of Chemical Information and Modeling, acs.jcim.3c01518 (2024)](http://dx.doi.org/10.1021/acs.jcim.3c01518). We originally described occupancy fingerprints in [Journal of Chemical Information and Modeling 58, 1915--1925 (2018)](http://dx.doi.org/10.1021/acs.jcim.8b00314).

* [JAX AMBER](https://github.com/swillow/jax_amber) is our implementation of the AMBER force field in JAX, a numerical framework used in machine learning. We used the code in [Journal of Chemical Physics 159, 124104 (2023)](http://dx.doi.org/10.1063/5.0164662).

<!-- * [Nonlinear least squares for concentration response curves](https://github.com/vanngocthuyla/crc/tree/main/nls_crc), which fits to concentration -->

* [pdb2amber](https://github.com/swillow/pdb2amber) which prepares membrane protein systems for simulation with the AMBER force field.

* [Robosample](https://github.com/spirilaurentiu/Robosample), which uses algorithms from robotics to perform molecular dynamics simulations.
...
David teaches an advanced undergraduate class on computational chemistry and drug design and makes [resources including lecture notes](https://daveminh.github.io/Chem456-2026S/) and [website code](https://github.com/daveminh/Chem456-2026S) available.

David has also worked with interprofessional project (IPRO) groups at Illinois Tech to develop a <a title="https://github.com/gkumar7/AlGDock" href="https://github.com/gkumar7/AlGDock">web-based graphical user interface for AlGDock</a>. An IPRO team has also developed <a title="https://github.com/Aczopek/Ipro-spring-2016" href="https://github.com/Aczopek/Ipro-spring-2016">image analysis for ball-and-stick models to generate chemical graphs</a>, which may be used for interactive exercises in organic chemistry.
